...
1) Run `./gradlew :core:publishToMavenLocal`
2) Open `~/.m2/repository/io/github/rribeiro5/koani/`
...
4) Add these lines to `gradle.properties`:
   ...
   ```
5) Run `./gradlew :core:publishAndReleaseToMavenCentral --no-configuration-cache`
